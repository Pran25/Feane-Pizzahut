...
function Cart() {  
  ...
  function Purchase()
  {
    alert("Thank you for purchasing your total Bill is : "+gettotal())
    window.location.reload()
  ...
  return (
    <div>
      ...
      <div>
      <Button variant="warning" className='text-white fs-5 px-4 rounded-pill mt-5' onClick={()=>Purchase()}>Purchase now</Button>
      </div>
    </div>
  )
}
